...
4. Set **OpenAI API Key**: `antigravity` (or a Virtual Key `rk-...` if you have PostgreSQL configured)
...
- If you have Virtual Keys configured, use an `rk-...` key instead of `antigravity`
